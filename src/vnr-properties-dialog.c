...
GtkWidget *
vnr_properties_dialog_new (VnrWindow *vnr_win, GCallback next_cb, GCallback prev_cb)
{
    ...
    g_signal_connect_swapped (dialog->next_button, "clicked", next_cb, vnr_win);
    g_signal_connect_swapped (dialog->prev_button, "clicked", prev_cb, vnr_win);
